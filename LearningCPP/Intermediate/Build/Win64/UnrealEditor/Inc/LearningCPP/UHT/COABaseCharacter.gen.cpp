...
#include "LearningCPP/Public/COABaseCharacter.h"
...
LEARNINGCPP_API UClass* Z_Construct_UClass_ACOABaseCharacter_NoRegister();
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACOABaseCharacter_Statics::NewProp_MaxHealth = { "MaxHealth", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACOABaseCharacter, MaxHealth), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MaxHealth_MetaData), NewProp_MaxHealth_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACOABaseCharacter_Statics::NewProp_HealingRate = { "HealingRate", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACOABaseCharacter, HealingRate), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_HealingRate_MetaData), NewProp_HealingRate_MetaData) };
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ACOABaseCharacter_Statics::NewProp_WalkSpeed = { "WalkSpeed", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACOABaseCharacter, WalkSpeed), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WalkSpeed_MetaData), NewProp_WalkSpeed_MetaData) };
...
template<> LEARNINGCPP_API UClass* StaticClass<ACOABaseCharacter>()
{
	return ACOABaseCharacter::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_Onur_Documents_Unreal_Projects_LearningCPP_Source_LearningCPP_Public_COABaseCharacter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ACOABaseCharacter, ACOABaseCharacter::StaticClass, TEXT("ACOABaseCharacter"), &Z_Registration_Info_UClass_ACOABaseCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACOABaseCharacter), 3756756197U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_Onur_Documents_Unreal_Projects_LearningCPP_Source_LearningCPP_Public_COABaseCharacter_h_995976961(TEXT("/Script/LearningCPP"),
	Z_CompiledInDeferFile_FID_Users_Onur_Documents_Unreal_Projects_LearningCPP_Source_LearningCPP_Public_COABaseCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_Onur_Documents_Unreal_Projects_LearningCPP_Source_LearningCPP_Public_COABaseCharacter_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
